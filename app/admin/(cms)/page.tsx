...
export default function AdminDashboardPage() {
  ...
  return (
    <AdminShell
      title="Dashboard"
      description="Pick a page to edit. Changes save to your Google Sheet and appear on the live site."
    >
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="text-sm text-zinc-500 mb-4">
            Hero, about, skills, experience, projects, education — each section has its own page.
          </p>
          <span className="mono text-xs text-accent inline-flex items-center gap-1">
            Edit landing <ArrowRight className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" />
          </span>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-zinc-500 mb-4">
            {published} published · {drafts} drafts — listing page, posts, and AI-assisted writing.
          </p>
          <span className="mono text-xs text-accent inline-flex items-center gap-1">
            Manage blog <ArrowRight className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" />
          </span>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-zinc-500 mb-4">
            Generate 1–3 weekly post ideas with Google Gemini (free tier). Pick one, edit, publish.
          </p>
          <span className="mono text-xs text-accent inline-flex items-center gap-1">
            Open AI studio <ArrowRight className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" />
          </span>
        </Link>
      </div>
    </AdminShell>
