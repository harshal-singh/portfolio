...
export default function SkillsEditorPage() {
  ...
  async function handleSave() {
    setSaving(true);
    try {
      await saveSectionHeaders({ skills: sections.skills });
  ...
  return (
    <AdminShell
      title="Skills"
      description="Stack section: categories and tags."
    >
        ...
        <AdminField label="Section label">
          <Input
            ...
            onChange={(e) =>
              setSections({
                ...sections,
                skills: { ...sec, label: e.target.value },
              })
            }
          />
        </AdminField>
        <AdminField label="Title">
          <Input
            ...
            onChange={(e) =>
              setSections({
                ...sections,
                skills: { ...sec, title: e.target.value },
              })
            }
          />
        </AdminField>
        <AdminField label="Description">
          <Textarea
            ...
            onChange={(e) =>
              setSections({
                ...sections,
                skills: { ...sec, description: e.target.value },
              })
            }
            rows={2}
          />
